module.exports = {
  ...
  subtitle(data) {
    ...
    if (data.storage < 3) {
      return `Channel ${channels[data.storage]} -> Permissions ${
        variables[data.storage3]
      } (${data.varName4})`;
    }
    return `Channel ${channels[data.storage]} (${
      data.varName3
    }) -> Permissions ${variables[data.storage3]} (${data.varName4})`;
  },
